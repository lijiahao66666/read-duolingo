package com.lijiahao.read.service.llm;

import com.alibaba.fastjson2.JSON;
import com.knuddels.jtokkit.Encodings;
import com.knuddels.jtokkit.api.Encoding;
import com.lijiahao.read.service.llm.seedx.SeedXCompletionRequest;
import com.lijiahao.read.service.llm.seedx.SeedXCompletionResponse;
...
public class LLMService {
    ...
    private boolean acquireTokens(AtomicInteger tokenCounter, int requiredTokens) {
        ...
        while (true) {
            ...
            if (newCount <= LLMService.seedXTotalMaxTokens) {
